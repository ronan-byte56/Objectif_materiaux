...
const questions = {
  ...
  "terminale": [
    ...
    { "q": "INJECTION : Qu'est-est le volume d'injection ?", "a": ["surface", "course", "volume", "quantite"], "r": "C'est la section de la vis multipliée par la course d'injection." },
    ...
    { "q": "LEAN : Qu'est-ce qu'un andon ?", "a": ["signal", "alerte", "probleme", "lumineux"], "r": "Un système d'alerte visuelle signalant un problème sur la ligne." },
...
function sauvegarderSession() {
    const etat = {
        niveau: niveauActuel,
        questions: questionsAffichees,
        index: indexQuestion,
        score: score,
        timer: timerGlobal
    };
    localStorage.setItem('quiz_encours', JSON.stringify(etat));
}
